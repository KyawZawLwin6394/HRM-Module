...
const config = {
  development: {
    ...
    uploadsURI: ['./uploads/hrm/employee/edu','./uploads/hrm/employee/pf', './uploads/hrm/employee/cv', './uploads/hrm/employee/other', './uploads/hrm/employee/recLet'],
    dbName: 'HRM',
    maxLoginAttempts: 5,
    lockTime: 30 * 60 * 1000,
  ...
  production: {
    ...
    //db: 'mongodb+srv://dbuser:P7qBNveg8bVO1d2z@cluster0.85ozwwv.mongodb.net/hrm?retryWrites=true&w=majority',
    db: 'mongodb+srv://projectDev-01:O9YGEyPQvKyA3Q48@kwintechinstances.usgwoxy.mongodb.net/HRM?retryWrites=true&w=majority',
    uploadsURI: ['./uploads/hrm/employee/edu', './uploads/hrm/employee/cv','./uploads/hrm/employee/pf', './uploads/hrm/employee/other', './uploads/hrm/employee/recLet'],
    dbName: 'HRM',
    maxLoginAttempts: 5,
    lockTime: 30 * 60 * 1000,
    jwtSecret: 'McQTEUrP=ut*Cr1e4trEDO$q796tEDHz+Sf9@0#YpKFMDZmHR@th5y=7VJtcXk3WU',
