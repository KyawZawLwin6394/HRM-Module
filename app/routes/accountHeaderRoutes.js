...
const AccountHeaderModel = require('../models/accountHeader')
const validatePayloadAgainstSchema = require('../middleware/main').validatePayloadAgainstSchema

module.exports = (app) => {

    app.route('/api/account-header')
        .post(validatePayloadAgainstSchema(AccountHeaderModel), catchError(accountHeader.createAccountHeader))
